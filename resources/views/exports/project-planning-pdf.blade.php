...
<head>
    ...
    <style type="text/css">
        * {
        ...
        /* ===== META BLOCK (à la "Generated by..." de l'exemple) ===== */
        .meta-block {
            margin-bottom: 20px;
            font-size: 8.7pt;
            color: #222222;
        ...
        /* Priorité — échelle d'étoiles monochrome, pas de couleur */
        .priority-stars {
            font-size: 9pt;
            letter-spacing: 1px;
        }
        ...
        /* Statut — case + libellé, style "checkbox" monochrome */
        .status-box {
            font-size: 9pt;
            margin-right: 4px;
        }
...
<body>
    ...
    <div class="section">
        ...
        <div class="section-note">Chaque sprint correspond à un objectif du projet. Les tâches y sont regroupées avec leur échéance, leur responsable, leur priorité et leur statut.</div>
        ...
        <table class="planning-table">
            <thead>
                <tr>
                    ...
                    <th class="col-sprint">Sprint / Objectif (intervalle)</th>
