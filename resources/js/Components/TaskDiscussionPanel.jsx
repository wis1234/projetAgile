...
/**
 * Panneau de discussion complet d'une tâche : messages, audio, photos, réactions,
 * mentions, présence en ligne, indicateur de frappe, accusés de lecture.
 * Autonome : peut être monté sur n'importe quelle page (fiche tâche, page dédiée...).
 */
export default function TaskDiscussionPanel({ task, projectMembers = [], headerLeftSlot = null }) {
