...
export default function Take({ project, quiz, questions = [], attempt }) {
  ...
  const saveProgress = async (newAnswers, logs = cheatingLogsRef.current) => {
    try {
      ...
      await fetch(route('quiz-attempts.save-progress', attempt.id), {
        method: 'POST',
        headers: {
      ...
      console.error('Erreur de sauvegarde progressive:', e);
    }
  };
  ...
  if (!questions || questions.length === 0) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-950 p-4">
        <p className="text-gray-500">Ce quiz ne contient aucune question.</p>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 py-6 px-4 select-none">
        ...
        <div className="fixed inset-0 z-50 bg-black/90 flex items-center justify-center text-white p-6 text-center">
          <div className="max-w-md space-y-4">
            ...
            <p className="text-sm text-gray-300">
              Veuillez rester sur cette page jusqu'à la fin de votre tentative. Cette action a été consignée dans le rapport de surveillance.
            </p>
            <button
        ...
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white dark:bg-gray-800 rounded-2xl max-w-md w-full p-6 shadow-2xl border border-gray-100 dark:border-gray-700 space-y-5 animate-in fade-in zoom-in duration-200">
            ...
            <div className="text-center">
              <h3 className="text-xl font-extrabold text-gray-900 dark:text-white">Soumettre le Quiz ?</h3>
      ...
      <div className="max-w-3xl mx-auto space-y-6">
        {/* Sticky Header Bar with Quiz Title & Timer */}
