...
import { FaArrowLeft, FaArrowRight, FaCheckCircle, FaExclamationTriangle, FaEyeSlash } from 'react-icons/fa';
        ...
        <div className="fixed inset-0 z-50 bg-black/90 flex items-center justify-center text-white p-6 text-center">
          <div className="max-w-md space-y-4">
            ...
            <p className="text-sm text-gray-300">
              Veuillez rester sur cette page jusqu'à la fin de votre tentative.
            </p>
            <button
