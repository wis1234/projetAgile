                ...
                <div className="p-8 md:p-10 space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="flex flex-col items-center p-6 bg-gray-50 dark:bg-gray-700 rounded-lg text-center">
                            ...
                            <a href="mailto:ronaldoagbohou@gmail.com" className="mt-2 text-blue-600 dark:text-blue-400 hover:underline">ronaldoagbohou@gmail.com</a>
                        </div>
                        ...
                        <div className="flex flex-col items-center p-6 bg-gray-50 dark:bg-gray-700 rounded-lg text-center">
                            ...
                            <a href="tel:+2290167419414" className="mt-1 text-blue-600 dark:text-blue-400 hover:underline">+229 01 67 41 94 14</a>
                        </div>
                    </div>
                </div>
            </div>
