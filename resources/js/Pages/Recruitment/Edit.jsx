...
export default function RecruitmentEdit({ recruitment }) {
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        experience_level: recruitment.experience_level || '',
        education_level: recruitment.education_level || '',
        skills: recruitment.skills || [],
        custom_fields: recruitment.custom_fields || [],
        status: recruitment.status || 'draft',
        new_skill: '',
        deadline: recruitment.deadline ? formatDateTimeForInput(recruitment.deadline) : format(new Date(Date.now() + 30 * 24 * 60 * 60 * 1000), "yyyy-MM-dd'T'HH:mm"),
        auto_close: recruitment.auto_close !== undefined ? recruitment.auto_close : true
    });
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(route('recruitment.update', recruitment.id));
    };
                        ...
                        <div className="p-6 bg-white border-b border-gray-200">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="flex justify-between pt-6 border-t border-gray-200">
                                    ...
                                    >
                                        <FaTrash className="mr-2" /> Supprimer l'offre
                                    </button>
